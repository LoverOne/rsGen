...
if "!rs_os_flag!"=="W10" (
    echo,
    echo  [93m°æWindows Command°ø[0m
    ...
    echo,
    powershell -c write-host "' °æWindows Command°ø'" -f yellow 2>nul
    ...
    echo,
    powershell -c write-host "' °æLinux Command°ø'" -f yellow 2>nul
...
if "!rs_os_flag!"=="W10" (
    ...
    echo,
    powershell -c write-host "' °æWin&Linux°ø'" -f yellow 2>nul
